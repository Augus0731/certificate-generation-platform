  ...
  <div>
    ...
    <el-card>
      ...
      <el-table fit :data="tableData" stripe border style="width: 100%">
        ...
        <el-table-column prop="organizeSchool" label="承办学校">
        </el-table-column>
        ...
        <el-table-column prop="matchIntroduction" label="比赛介绍">
        </el-table-column>
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="addNewEvent">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
